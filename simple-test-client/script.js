...
const socketConnectionStatusSpan = document.querySelector('span#socket-connection-status');
...
const resetTokenField = document.querySelector('form#reset-password input[name="resetToken"]');
...
socket.io.on('open', (...args) => {
   console.log('Open');
   socketConnectionStatusSpan.innerHTML = 'Connected';
});
// socket.io.on('error', (...args) => {
//    console.log('Error', args);
//    socketConnectionStatusSpan.innerHTML = 'Error';
// });
socket.io.on('close', (...args) => {
   console.log('close', args);
   socketConnectionStatusSpan.innerHTML = 'Disconnected';
});

socket.io.on('reconnect_attempt', (attempts) => {
   socketConnectionStatusSpan.innerHTML = `Connecting[${attempts}]...`;
});

socket.on('connect_error', (err) => {
   console.warn(`Unable to connet to the server ->[${err.message}]`);
});
